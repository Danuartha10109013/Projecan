...
<div class="btn btn-primary"><a style="color:white" href="{{route('admin.dashboard')}}">Kembali</a></div>
<div class="btn btn-warning"><a style="color:white" href="{{route('admin.profile-edit')}}">Edit</a></div>
</div>
</section>
