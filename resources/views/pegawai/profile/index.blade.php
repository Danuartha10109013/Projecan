...
<div class="btn btn-primary"><a style="color:white" href="{{route('pegawai.dashboard')}}">Kembali</a></div>
<div class="btn btn-warning"><a style="color:white" href="{{route('pegawai.profile-edit')}}">Edit</a></div>
</div>
</section>
