      ...
      <div class="az-content-body">
        <div class="az-dashboard-one-title">
          <div>
            ...
            <p class="az-dashboard-text">{{Auth::user()->name}}</p>
          </div>
          <div class="az-content-header-right">
            ...
            <div class="media">
              <div class="media-body">
                <label>Tugas Diselesaikan</label>
                <h6>--</h6>
              </div><!-- media-body -->
            </div><!-- media -->
            <div class="media">
            ...
            <a href="" class="btn btn-purple">Presensi</a>
          </div>
        </div><!-- az-dashboard-one-title -->

        <div class="az-dashboard-nav"> 
          <nav class="nav">
            <a class="nav-link" data-toggle="tab" href="#">Overview Presensi</a>
            
          </nav>

          <nav class="nav">
            <a class="nav-link" href="#"><i class="far fa-calendar"></i> Hari Ini</a>
            <a class="nav-link" href="#"><i class="far fa-calendar-alt"></i> Bulan Ini</a>
            <a class="nav-link" href="#"><i class="fas fa-calendar-check"></i>Tahun Ini</a>
